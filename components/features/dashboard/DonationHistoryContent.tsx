...
import { Heart, ExternalLink, Clock, CheckCircle, XCircle } from 'lucide-react';
...
interface DonationHistoryContentProps {
...
export default function DonationHistoryContent({ donations }: DonationHistoryContentProps) {
  return (
