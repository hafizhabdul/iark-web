...
export function HeroSection({ className = '', initialData }: HeroSectionProps) {
  ...
  return (
    <section className={`relative min-h-screen bg-white overflow-hidden ${className}`}>
      ...
      <div className="hidden md:block absolute top-32 right-1/4 w-12 h-12 bg-iark-red rounded-full opacity-20 animate-pulse-slow" />
      <div className="hidden md:block absolute top-1/3 left-20 w-8 h-8 bg-iark-blue rounded-full opacity-20 animate-drift" />
      <div className="hidden md:block absolute bottom-1/3 right-20 w-10 h-10 bg-iark-yellow rounded-full opacity-30 animate-pulse-slow" />

      {/* Main Content */}
      <div className="relative z-10 flex flex-col items-center justify-center px-5 pt-20 pb-10 md:px-8 md:pt-24 md:pb-16 min-h-screen">
        ...
        {/* Headline */}
        <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-center text-gray-900 mb-4 md:mb-6 max-w-5xl leading-snug md:leading-tight"
          style={{
        ...
        {/* Subheadline */}
        <p className="text-base md:text-xl text-center text-gray-600 mb-6 md:mb-10 max-w-2xl">
        ...
        <Link href="/masuk">
          <motion.div
            className="bg-iark-red text-white font-bold px-6 py-3 text-base md:px-8 md:py-4 md:text-lg rounded-full shadow-lg flex items-center gap-2 cursor-pointer relative overflow-hidden"
