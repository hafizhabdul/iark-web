...
export function BidangSection({ className = '' }: BidangSectionProps) {
  ...
  // Extended organization data structure with all Bidang
          ...
          children: [
            ...
            // Ketua 2 with 3 Bidang
            {
              ...
              children: [
                ...
                {
                  label: 'Bidang Distrik Barat',
                  data: {
                    name: 'Ratna Sari',
                    position: 'Ketua Bidang',
                    photo: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&q=80',
                    level: 'Level 3',
                    description: 'Distrik Barat',
                    color: 'yellow',
                  } as LeadershipData,
                },
              ],
            },
            // Ketua 3 with 3 Bidang
            {
              label: 'Ketua 3',
              expanded: true,
              data: {
              ...
              children: [
                {
                  label: 'Bidang Distrik Timur',
                  data: {
                    name: 'Bambang Santoso',
                    position: 'Ketua Bidang',
                    photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&q=80',
                    level: 'Level 3',
                    description: 'Distrik Timur',
                    color: 'yellow',
                  } as LeadershipData,
                },
                {
  ...
  const nodeTemplate = (node: TreeNode) => {
    ...
    const isBidang = data.level === 'Level 3';
    ...
    return (
      ...
      >
        ...
        {/* Bidang count for Division Leaders only */}
        {isDivisionLeader && (
    ...
    <section className={`relative py-24 px-8 bg-white overflow-hidden ${className}`}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <p className="text-lg md:text-xl text-center text-gray-600 mb-16 max-w-3xl mx-auto">
          Struktur lengkap organisasi IARK dari tingkat kepemimpinan hingga bidang operasional
        </p>
